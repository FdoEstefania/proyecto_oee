...
if(isset($_GET["inicio"])&&($_GET["nom"])&&($_GET["ape"])&&($_GET['vel'])&&($_GET["fk"]&&($_GET["ord"]))){
    $inicio=$_GET['inicio'];
    $nom=$_GET['nom'];
    $ape=$_GET['ape'];
    $vel=$_GET['vel'];
    ...
    $consulta="INSERT INTO turno(inicio, nom_opera, ape_opera, velocidad_pro, fk_maquina,fk_tab_ext ) VALUES ('{$inicio}', '{$nom}', '{$ape}', '{$vel}', '{$fk}', '{$ord}')";
